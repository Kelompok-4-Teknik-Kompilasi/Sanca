...
from errorHandler import IllegalCharError, RTError
from tokens import TT_ARROW, TT_EOF, TT_COMMA, TT_DIV, TT_EE, TT_EQ, TT_FLOAT, TT_GT, TT_GTE, TT_IDENTIFIER, TT_INT, TT_KEYWORD, TT_LPAREN, TT_LT, TT_LTE, TT_MINUS, TT_MUL, TT_PLUS, TT_NE, TT_POW, TT_RPAREN, TT_STRING, TT_NEWLINE
...
class BuiltInFunction(BaseFunction):
    ...
    def execute_run(self, exec_ctx):
        ...
        _, error = runProgram.run(fn, script)
